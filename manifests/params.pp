...
class icinga::params {
  ...
  case $operatingsystem {
    ...
    /^(Debian|Ubuntu)$/: {
      ...
      #Finally, pick the right list of packages:
      $icinga_server_packages = ["icinga", "icinga-doc", "icinga-idoutils", "nagios-nrpe-server", "nagios-plugins", "nagios-plugins-basic", "nagios-plugins-common", "nagios-plugins-standard", "nagios-snmp-plugins", "nagios-plugins-extra", "nagios-plugins-contrib", $lib_db_package]
